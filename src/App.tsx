          ...
          <div className="mb-6 flex gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-1 rounded-lg border border-gray-200 bg-white p-3 text-[13px] text-gray-700 leading-relaxed">
                ...
                <p className="mb-2"><span className="text-blue-600 font-medium">@Alex Chen</span> — Your message for <span className="font-medium">#engineering</span> has been prepared:</p>
          ...
          <div className="mb-6 flex gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-1 rounded-lg border border-gray-200 bg-white p-3 text-[13px] text-gray-700 leading-relaxed">
                ...
                <p className="mb-2"><span className="text-blue-600 font-medium">@Alex Chen</span> — Your email to <span className="font-medium">sarah.chen@company.com</span> has been prepared:</p>
                <div className="border-l-[3px] border-green-500 pl-3">
          ...
          <div className="mb-6 flex gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-1 rounded-lg border border-gray-200 bg-white p-3 text-[13px] text-gray-700 leading-relaxed">
                ...
                <p className="mb-2"><span className="text-blue-600 font-medium">@Alex Chen</span> — Your message has been prepared:</p>
                <div className="border-l-[3px] border-green-500 pl-3">
          ...
          <div className="mb-6 flex gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-1 rounded-lg border border-gray-200 bg-white p-3 text-[13px] text-gray-700 leading-relaxed">
                ...
                <p className="mb-2"><span className="text-blue-600 font-medium">@Alex Chen</span> — Your deliverables are ready. 3 files included:</p>
